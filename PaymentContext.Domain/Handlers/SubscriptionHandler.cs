...
namespace PaymentContext.Domain.Handlers
{
        ...
        IHandler<CreatePayPalSubscriptionCommand>
    {
        ...
        public ICommandResult Handle(CreateBoletoSubscriptionCommand command)
        {
            ...
            // Verificar se a documento já está cadastrado
            ...
            var address = new Address(command.Street, command.Number, command.Neighborhood, command.City, command.State, command.Coutry, command.ZipCode);
